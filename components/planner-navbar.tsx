      ...
      <div className=" flex flex-col container  mx-auto px-4 py-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            ...
            <div className="p-2 max-md:hidden ml-7 rounded-lg border-2 border-green-300 text-sm text-muted-foreground">
              {todayFormatted}
            </div>
          </div>
          ...
          <div className="flex max-md:hidden items-center space-x-4">
            <Button variant="outline" className="rounded-lg border-2 border-green-300 hover:bg-green-300 hover:text-green-800" size="sm" onClick={onPreviousWeek}>
            ...
            <Button variant="outline" className="rounded-lg border-2 border-green-300 hover:bg-green-300 hover:text-green-800" onClick={onNextWeek}>
          ...
          <div className="flex max-md:hidden items-center space-x-2">
            {showAllWeekends ? (
              <Link href="/planner">
                <Button className="rounded-lg border-2 border-green-300 hover:bg-green-300 hover:text-green-800" variant="outline" size="sm">
